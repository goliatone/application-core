...
const DEFAULTS = {
     ...
     * and modules. Relative to applciation
     *
     * @type {Object}
     */
    loaders: {
...
class Application extends EventEmitter {
    ...
    _mount() {
        ...
        this.loader = new PluginLoader({
            ...
            afterMount: function(context) {
                context.emitPluginReady('coreplugins');
            }
        });
    ...
    register(instance, name) {
        ...
        function _register(context, name, instance) {
             ...
             */
            context.emitPluginReady(name, out);
        }
    ...
    emitPluginReady(moduleid, event) {
        this.emit(`${moduleid}.${this.registerReadyEvent}`, event);
    }
...
//////////////////////////////////////////
    ...
    /**
     * @TODO: Set timeout so that resolves don't go undefined.
     *
    ...
    _registerListeners() {
        ...
        this.once(`coreplugins.${this.registerReadyEvent}`, ()=>{
            this._logger.info('Core modules loaded...');
        });

        this.once(`modules.${this.registerReadyEvent}`, ()=>{
