...
class Application extends EventEmitter {
    ...
    init(config) {
        ...
        var self = this;
        this.coremodules.map(function(module){
            console.log('coremodule', module);
        ...
        if(this.loaders){
            ...
            if(this.loaders.modules){
                // if(typeof this.loaders.modules === 'string') this.loaders.modules = [this.loaders.modules];
                this.loadDirectory(this.loaders.modules);
            }

            if(this.loaders.handlers){
                // if(typeof this.loaders.handlers === 'string') this.loaders.handlers = [this.loaders.handlers];
                this.loadHanlders(this.loaders.handlers);
            }
        }
    }
